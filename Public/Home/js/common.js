...
/*首页产品中心*/
        $(".pro_list_1").click(function(){ $(this).children("ul").stop().slideDown(300).parent(".pro_list_1").siblings(".pro_list_1").children("ul").stop().slideUp(300);
        })
        
        $(function () {
    $('.pro_con_r_show ul li a img').hover(
        function () {
            var $this = $(this);
            $this.stop().animate({
                'width': '289px',
