...
<div class="panel admin-panel">
 <form action='' name="myform" id="myform" method="post">
  ...
  <div class="padding border-bottom">
      <a class="button border-yellow" href="<?php echo U('Column/cate_add');?>"><span class="icon-plus-square-o"></span> 添加分类</a>
 ...
 $yy=0; dig($cat,$yy); function dig($cat,$yy){ $yy++; foreach($cat as $key => $val){ if($val['pid']==0){ $ss=0; }else{ $ss=$yy; } ?>
      ...
      <?php } ?>
          ...
          <td><div class="button-group"> <a class="button border-main" href="<?php echo U('Column/cate_save?id='.$val['id']);?>"><span class="icon-edit"></span> 修改</a> <a class="button border-red" href="<?php echo U('Column/cate?id='.$val['id']);?>" onclick="return confirm('您确定要删除吗?');"><span class="icon-trash-o"></span> 删除</a> </div></td>
      </tr>
