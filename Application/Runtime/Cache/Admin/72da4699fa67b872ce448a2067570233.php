  ...
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o" href="<?php echo U('Product/twoproduct_add');?>"> 添加内容</a> </li>
      </ul>
    </div>
    <table class="table table-hover text-center">
      ...
      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
          ...
          <td class="td"><a href="<?php echo U('/Admin/Product/product_details','id='.$vo['id']);?>"><img width="40%" src="/yvanfa/Public/Uploads/<?php echo ($vo["img"]); ?>" /> </a></td>
          <td><?php echo ($vo["fang_fa"]); ?></td>
          <td><?php echo ($vo["time"]); ?></td>
          <td>
              <div class="button-group">
                  <a class="button border-main" href="<?php echo U('/Admin/Product/twoproduct_save','id='.$vo['id']);?>"><span class="icon-edit"></span> 修改</a>
                  <a class="button border-red" href="<?php echo U('/Admin/Product/del','id='.$vo['id']);?>" onclick="return confirm('您确定要删除吗?')">
