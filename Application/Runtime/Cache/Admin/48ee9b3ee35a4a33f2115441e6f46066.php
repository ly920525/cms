  ...
  <div class="body-content">
    <form method="post" class="form-x" action="" onsubmit="return checkinput()">
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" id="name" name="title" value="<?php echo $sort['type'];?>" placeholder="请输入分类标题" />
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="fang_fa" value="<?php echo $sort['fang_fa'];?>" placeholder="请输入所属方法" />
