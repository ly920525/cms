        ...
        <form method="post" class="form-x" action="" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <div class="field">
                    <select name="xiala" class="input w50 inputs" >
                        ...
                        <?php if(is_array($cate)): foreach($cate as $key=>$val): if($val['pid']==0){ ?>
                            <option value="<?php echo ($val["id"]); ?>"><?php echo ($val["title"]); ?></option>
                            <?php } endforeach; endif; ?>
                    </select>
                    <div class="tips">（不选择上级栏目默认为一级栏目）</div>
                </div>
            </div>
            <div class="form-group">
                <div class="label">
                ...
                <div class="field">
                    <input type="text" class="input w50" id="catname" name="title" placeholder="请输入栏目标题" data-validate="required:请输入栏目标题" />
            ...
            <div class="form-group">
                ...
                <div class="field">
                    ...
                    <div class="tips" id="tubiao">小图标显示：</div>
                </div>
            </div>
            <div class="form-group">
                <div class="label">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <button class="button bg-main icon-check-square-o catjc" type="submit"> 提交</button>
