    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
        ...
        <td>
            <div class="button-group">
                <a class="button border-main" href="<?php echo U('Honor/honor_save',array('id'=>$vo['id']));?>"><span class="icon-edit"></span> 修改</a>
                <a class="button border-red" href="<?php echo U('/Admin/Honor/honorel',array('id'=>$vo['id']));?>" onclick="return confirm('您确定要删除吗?');"><span class="icon-trash-o"></span> 删除</a>
            </div>
        </td>
...
<div class="panel admin-panel margin-top">
  <div class="panel-head" id="add"><strong><span class="icon-pencil-square-o"></span>添加荣誉分类</strong></div>
      ...
      <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="field">
                ...
                <input type='hidden'  id="sortsjc" value="<?php echo U('Honor/jiances');?>" />
            </div>
        </div>
