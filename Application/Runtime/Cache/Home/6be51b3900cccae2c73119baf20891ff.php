            ...
            <div class="pro_con_l left">
                ...
                <div class="pro_con_list">
                    ...
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="news_list_1 ">
                            <div class="list_title <?php if($vo['sort']==$issuer){echo 'active';} ?>">
                                <p>
                                    <a href="<?php echo U('/Home/News/news',array('issuer'=>$vo['sort']));?>"><?php echo ($vo["type"]); ?></a>
                                </p>
                            </div>
                            <ul>
                            </ul>
                ...
                <div class="news_list_ny">
                    <ul>
                        ...
                        <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li>
                                <a href="<?php echo U('News/news_details','id='.$v['id']);?>">
                                    <p class="left"><?php echo ($v["title"]); ?></p>
                        ...
                        <!--<li>-->
                            <!--<a href="<?php echo U('News/news_details');?>">-->
                                <!--<p class="left">新闻标题新闻标题新闻标题新闻标题新闻标题新闻标题新闻标题新闻标题</p>-->
                                <!--<span class="right">2017-01-01</span>-->
                                <!--<div class="clear"></div>-->
                            <!--</a>-->
                        <!--</li>-->
                        <!--<li>-->
